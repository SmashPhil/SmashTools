...
public sealed class KuhnMunkres
{
	...
	/// <summary>
	/// Initialize a KuhnMunkres matrix solver, distributing <paramref name="n"/> workers to <paramref name="n"/> potential jobs
	/// </summary>
	/// <param name="n">Number of workers to distribute.</param>
